...
-- Command     : write_vhdl -force -mode funcsim d:/GIT/phos-fec-v1.0/xilinx_ip/pll/main_pll/main_pll_sim_netlist.vhdl
-- Design      : main_pll
...
architecture STRUCTURE of main_pll_main_pll_clk_wiz is
  ...
  signal clk_out1_main_pll : STD_LOGIC;
  signal clk_out2_main_pll : STD_LOGIC;
  signal clk_out3_main_pll : STD_LOGIC;
  signal clk_out4_main_pll : STD_LOGIC;
  signal clk_out5_main_pll : STD_LOGIC;
...
begin
inst: entity work.main_pll_main_pll_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
